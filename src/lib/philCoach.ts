...
export const PHIL_ROLES: PhilRole[] = [
  ...
  },
  {
    ...
    how: '沿着你反复出现的词和前后变化，陪你看见真正想要什么、为什么重要',
  },
  {
    id: 'advisor',
    name: '照见选择',
    when: '站在一个选择前，两边都有舍不得，也都有一点不确定',
    how: '把利弊、边界和你真正在乎的事摆到一起；最后怎么选，仍然回到你手里',
  },
  {
    id: 'mentor',
    name: '落到一小步',
    when: '你已经看见一点方向，想把它变成今天可以开始的行动',
    how: '把方向收成一个小而可逆的尝试，不替你保证结果，也不催你走得更快',
  },
];
