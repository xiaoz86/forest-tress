...
// ──────────────────────────────────────────────────────────────
// 中文（2026-08-09 已群发 11 位成员的那一版，逐字保持不变）
// ──────────────────────────────────────────────────────────────
const ZH: Letter = {
  subject: '附近森林致你的一封信｜走进自我，分享创造，相遇同行人',
  h1: '欢迎来到附近森林 🌳',
  tagline: '走进自我，分享创造，相遇同行人',
  greeting: name => (name ? `嗨，${name}：` : '嗨，亲爱的附近森林创造者：'),
  intro: [
    '欢迎来到「附近森林」。🌳',
    '如果你已经注册了这里，也许你会好奇：<strong>附近森林究竟可以用来做什么？</strong>',
    '我们想做的，并不只是一个展示个人主页、发布作品的平台。我们更希望它像一片真正的森林——',
  ],
  quote: '<strong>每个人都可以按照自己的方式生长，在这里回到自己，也走向彼此；被看见、被连接，并让一些真正有意思的事情共同发生。</strong>',
  loginCta: '进入我的节点',
  ...
  sections: [
    {
      ...
      paragraphs: [
        ...
        '你可以介绍自己，也可以逐渐发布和管理自己正在创造的事情：作品、项目、服务、活动、课程，或者一个刚刚萌芽的想法。',
    ...
    {
      heading: '💬 04｜PhilCoach：一个随时可以聊聊的 AI Virtual Coach',
      paragraphs: [
        '除了人与人的连接，我们也希望附近森林能够陪伴每个人<strong>回到自己</strong>。',
        '目前已经上线的 <strong>PhilCoach</strong>，就是我们正在探索的一种方式。它是一个融合了<strong>知心伙伴 × Life Coach × 顾问 × 导师</strong>角色的 AI Virtual Coach。',
    ...
    },
    {
      ...
      link: { label: '去冥想空间', href: `${SITE}/meditations` },
    },
    {
      heading: '🌙 06｜21 天改善睡眠冥想陪伴',
      paragraphs: [
        '睡眠，也是我们最近特别想认真陪伴大家的一件事。因此，我们正在附近森林中加入<strong>「21 天改善睡眠冥想陪伴」</strong>。',
        '它不是要求你必须「完成 21 天打卡」的挑战，而更像是一段温和的陪伴：每天睡前，留一点时间给自己。通过呼吸、身体放松、正念觉察和不同主题的睡前冥想，慢慢建立属于自己的睡前节奏。',
  ...
  bothWays: {
    ...
    cta: { label: '去看看森林里的创造者', href: `${SITE}/creators` },
  },
  earlyDays: [
  ...
  feedback: [
    '我们也很希望听见你的声音。如果你在使用附近森林、PhilCoach、冥想，或者参与 21 天改善睡眠冥想陪伴的过程中，有任何感受、想法、建议，甚至只是一个突然冒出来的 💡 Idea，都欢迎来找我们聊聊。',
    '<strong>这片森林并不是由我们设计完成之后，再交给大家使用。</strong>我们更希望，它是在每一个来到这里的人参与、反馈、连接与创造的过程中，<strong>一起慢慢长出来的。</strong>',
  ],
