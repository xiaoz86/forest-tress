...
export const home = {
  ...
  join: {
    ...
    wizard: {
      ...
      /**
        * 提交前的告知。放在按钮上方而不是某一步的小字里——
        * 「会出现在哪里」是按下去那一刻才真正发生的事，
        * 而且星空会用 AI 读你的资料并公开结论，那不该是事后才知道的。
        */
      whereYouAppear:
        '种下之后，你会出现在创造者森林，也会成为附近星空里的一颗星（都不含联系方式）。星空会用 AI 从你的「优势」和「在寻找」里看出可以一起做的事——不想进星空的话，之后在个人页可以关掉。',
      submit: '🌱 种下我的种子',
      submitting: '正在种下…',
