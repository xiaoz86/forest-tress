...
export const philCoach = {
  ...
  experience: {
    ...
    gate: {
      ...
      nameTitle: '怎么称呼你',
      /**
       * 导语只剩一件事要做：告诉他邮箱已经过关、不会再来一次。
       * 「这两条路各是什么」交给下面两颗按钮各自那行说明，别在这儿抢着说一遍。
       */
      newBody: '邮箱已经确认。选哪一条，都不会再发一次验证码。',
      lightJoin: '轻登记，继续对话',
      /** 说的是这一屏之后的下一步，不是数据库里存了什么——那句归 newPrivacy */
      lightDesc: '只留一个称呼，回去接着把话说完。',
      fullJoin: '完整注册节点',
      /**
       * 这三个词就是导航栏上的三扇门：回到自己 / 个体创造 / 遇见附近。
       * 不是在夸产品，是一张目录——第一次来的人读完这一行就知道里面有什么。
       *
       * 前面本来还有「走进附近森林——」，去掉了：那件事按钮自己说得清，
       * 而在窄屏上那半句会把整行挤到第二行，「相遇同行人。」的「人。」孤零零
       * 甩在下一行。现在两行说明都是 16 字，左边对齐、右边也齐。
       */
      fullDesc: '走进自我，分享创造，相遇同行人。',
      joining: '正在种下节点…',
      /** 后悔药。两颗按钮共用：选轻登记的怕被困住，选完整注册的怕现在没时间填 */
      newPrivacy: '轻登记只保存称呼和已验证邮箱，节点卡什么时候补都行。',
