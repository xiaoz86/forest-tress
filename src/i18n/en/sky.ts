...
export const sky: typeof zhSky = {
  ...
  panel: {
    ...
    whyTitle: 'Why you might be close',
    whyGive: 'What they offer around {topic} is what you wrote you were looking for.',
    whyTake: 'What you offer around {topic} is what they wrote they were looking for.',
    whyShared: 'You are both paying attention to {topics}.',
    whyOrbit: 'Your orbits both pass through {keywords}.',
    whyCity: 'You are both in {city}.',
    whyRecent: 'They updated their card recently — still moving.',
    endComplement: 'On this one, what each of you holds lines up.',
    endCity: 'Same city. Meeting is easier than it sounds.',
    endShared: 'Same subject, different approaches — usually the interesting part.',
    endDefault: 'You could start with a single conversation.',
